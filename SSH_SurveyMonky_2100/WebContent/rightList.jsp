			...
			<table>
				...
				<tbody>
					<s:iterator value="allRights" status="st">
						...
						<tr>
							<td>
								<s:textfield name="allRights[%{#st.index}].id"  value ="%{id}" cssClass="text" cssStyle="width:50px" readonly="true"/>
							</td>
							<td>
								<s:textfield name="allRights[%{#st.index}].rightName" value="%{rightName}" cssClass="text" cssStyle="width:150px"/>
							</td>
